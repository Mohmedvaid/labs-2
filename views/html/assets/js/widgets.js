  ...
  $.getJSON(widgetAPI, function (data) {
    ...
    for (var i in widgets) {
      ...
      var newItem =
        ...
        ' b-a b-grey bg-master-lightest" data-width="1" data-height="1" \
                data-createdat="' +
        widget['createdAt'] +
        '" \
                data-description="' +
                        ...
                        <div class="overlayer-wrapper item-info"> \
                            <div class="p-l-20 p-r-20 p-t-20 p-b-5"> \
                                <div class="item-footer"> \
                                    <h5 class="text-center text-white semi-bold m-b-0">' +
        widget['title'] +
        '</h5> \
                                    <p class="fs-12 text-white text-center"><span class="hint-text">Added on </span>' +
        moment(widget['createdAt']).format('D MMM YYYY') +
        '</p> \
